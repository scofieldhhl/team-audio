...
public final class IjkMediaPlayer extends AbstractMediaPlayer {
    ...
    private AudioTrack audiotrackinfo;
    ...
    /*sacdiso handle*/
   public static native int native_opensacdisofile(String libName, int bMultichannel, int fileIndex);
   public static native String native_getsacdiso_cue(String libName);
}
